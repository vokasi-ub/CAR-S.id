  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box-body table-responsive no-padding">
          ...
          <form action="searchmerk" method="get" class="sidebar-form">
          ...
          <button type="submit" class="btn btn-info pull-right"><a href="tambahmerk"> Insert </a></button>      
            ...
            <tr>
                ...
                <td> {{$li->merek}} </td>
                <td>  
                    <a href="/edit/merk/{{ $li->id_merek }}"> edit </a>
                    <a href="/hapus/merk/{{ $li->id_merek }}"> hapus </a>
                </td>
            </tr>
            @endforeach
          </table>
