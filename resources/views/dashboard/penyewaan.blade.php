  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box-body table-responsive no-padding">
          ...
          <form action="searchpenyewa" method="get" class="sidebar-form">
          ...
          <button type="submit" class="btn btn-info pull-right"><a href="tambahpenyewa"> Insert </a></button>      
            ...
            <tr>
                <td> {{$li->id_pelanggan}} </td>
                <td> {{$li->nama}} </td>
                <td> {{$li->no_hp}} </td>
                <td> {{$li->alamat}} </td>
                <td>  
                    <a href="/edit/penyewa/{{ $li->id_pelanggan }}"> edit </a>
                    <a href="/hapus/penyewa/{{ $li->id_pelanggan }}"> hapus </a>
                </td>
            </tr>
            @endforeach
          </table>
